...
function refreshCollection(){
  ...
  state.filtered=sortMemories(filterMemories(state.items,state.region,state.query),$('rating-sort').value);
...
async function refreshCloudReviews(){
  ...
  try{
    ...
    state.real=mergeMemories(base,validateMemories(placesData));
