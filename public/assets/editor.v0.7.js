import {normalizeCategory,CATEGORIES,categoryOf,categoryIcon,ratingTone} from './place-style.v0.7.js';
...
function select(id,newPlace=null){
  ...
  reviewCounts();dirty=false;options();renderPhotos();lock(false);
