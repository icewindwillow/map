...
import {officialIntroductions} from './officials.v0.9.js?v=0.9.1';
...
export function normalizeDetails(place) {
  ...
  const official=officialIntroductions[place.id]||[];
  return {...place,city:typeof place.city==='string'?place.city:place.id==='queens-wardrobe-exhibition'?'伦敦':cityFromAddress(place.locationLabel)||cityFromAddress(locations[place.id]),officialIntroduction:place.officialIntroduction||official[0]||'',officialSource:place.officialSource||official[1]||''};
}
